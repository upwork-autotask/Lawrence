...
export const disciplinaryCases = pgTable(
  'disciplinary_cases',
  {
    ...
    typeOfDisciplinary: text('type_of_disciplinary'),
    who: text('who'),
    incidentDate: timestamp('incident_date', { withTimezone: true }).notNull(),
    dateOfDisciplinary: timestamp('date_of_disciplinary', { withTimezone: true }),
    dateOfEnquiry: timestamp('date_of_enquiry', { withTimezone: true }),
    actionOpenDate: timestamp('action_open_date', { withTimezone: true }),
    actionClosedDate: timestamp('action_closed_date', { withTimezone: true }),
